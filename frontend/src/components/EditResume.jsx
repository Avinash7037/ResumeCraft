...
const EditResume = () => {
  ...
  const uploadResumeImages = async () => {
    try {
      ...
      // ✅ Fix Tailwind oklch colors directly in the element
      const fixedThumbnail = fixTailwindColors(thumbnailElement);

      // ✅ Pass fixed element to html2canvas (don’t remove it from DOM!)
      ...
      // ❌ Remove this → document.body.removeChild(fixedThumbnail);
      // The element is part of your app, don’t remove it
